...
const NativeHyperswitchSdk =
  TurboModuleRegistry.getEnforcing<Spec>('HyperModule');
...
export const exitPaymentMethodManagement =
  NativeHyperswitchSdk.exitPaymentMethodManagement;
