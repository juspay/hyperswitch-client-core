...
let useExternalThreeDs = () => {
  ...
  (
    ...
    let generateAuthenticationCallBody = (clientSecret, aReqParams: AuthenticationModule.aReqParams) => {
      // TODO: remove hardocded data after confirmation from BE
      let body: authCallBody = {
        ...
        sdk_information: {
          sdk_app_id: "sdkAppId",
          sdk_enc_data: aReqParams.sdkEncryptedData->Option.getOr(""),
          sdk_ephem_pub_key: {
            kty: "kty",
            crv: "crv",
            x: "x",
          ...
          sdk_reference_number: "sdkReferenceNo",
          sdk_max_timeout: 10,
        },
      }
