...
let getLocaleStrings: Js.Json.t => localeStrings = data => {
  ...
  | Some(res) => {
      ...
      phoneInvalidText: Utils.getString(res, "phoneInvalidText", defaultLocale.phoneInvalidText),
      blikCodeInvalidText: Utils.getString(
        res,
        "blikCodeInvalidText",
        defaultLocale.blikCodeInvalidText,
      ),
      ...
      accountHolderNameLabel: Utils.getString(
        res,
        "accountHolderNameLabel",
        defaultLocale.accountHolderNameLabel,
      ),
      accountHolderNamePlaceholder: Utils.getString(
        res,
        "accountHolderNamePlaceholder",
        defaultLocale.accountHolderNamePlaceholder,
      ),
      accountNumberPlaceholder: Utils.getString(
        res,
        "accountNumberPlaceholder",
        defaultLocale.accountNumberPlaceholder,
      ),
      bankIdentifierPlaceholder: Utils.getString(
        res,
        "bankIdentifierPlaceholder",
        defaultLocale.bankIdentifierPlaceholder,
      ),
      bankIssuerPlaceholder: Utils.getString(
        res,
        "bankIssuerPlaceholder",
        defaultLocale.bankIssuerPlaceholder,
      ),
      bankTypeLabel: Utils.getString(res, "bankTypeLabel", defaultLocale.bankTypeLabel),
      bankTypePlaceholder: Utils.getString(
        res,
        "bankTypePlaceholder",
        defaultLocale.bankTypePlaceholder,
      ),
      blikCodeLabel: Utils.getString(res, "blikCodeLabel", defaultLocale.blikCodeLabel),
      blikCodePlaceholder: Utils.getString(
        res,
        "blikCodePlaceholder",
        defaultLocale.blikCodePlaceholder,
      ),
      branchCodeLabel: Utils.getString(res, "branchCodeLabel", defaultLocale.branchCodeLabel),
      branchCodePlaceholder: Utils.getString(
        res,
        "branchCodePlaceholder",
        defaultLocale.branchCodePlaceholder,
      ),
      bsbNumberPlaceholder: Utils.getString(
        res,
        "bsbNumberPlaceholder",
        defaultLocale.bsbNumberPlaceholder,
      ),
      cardNetworkLabel: Utils.getString(res, "cardNetworkLabel", defaultLocale.cardNetworkLabel),
      cardNetworkPlaceholder: Utils.getString(
        res,
        "cardNetworkPlaceholder",
        defaultLocale.cardNetworkPlaceholder,
      ),
      cardNumberPlaceholder: Utils.getString(
        res,
        "cardNumberPlaceholder",
        defaultLocale.cardNumberPlaceholder,
      ),
      cityPlaceholder: Utils.getString(res, "cityPlaceholder", defaultLocale.cityPlaceholder),
      clientUidLabel: Utils.getString(res, "clientUidLabel", defaultLocale.clientUidLabel),
      clientUidPlaceholder: Utils.getString(
        res,
        "clientUidPlaceholder",
        defaultLocale.clientUidPlaceholder,
      ),
      countryPlaceholder: Utils.getString(
        res,
        "countryPlaceholder",
        defaultLocale.countryPlaceholder,
      ),
      cryptoNetworkLabel: Utils.getString(
        res,
        "cryptoNetworkLabel",
        defaultLocale.cryptoNetworkLabel,
      ),
      cryptoNetworkPlaceholder: Utils.getString(
        res,
        "cryptoNetworkPlaceholder",
        defaultLocale.cryptoNetworkPlaceholder,
      ),
      currencyPlaceholder: Utils.getString(
        res,
        "currencyPlaceholder",
        defaultLocale.currencyPlaceholder,
      ),
      cvcPlaceholder: Utils.getString(res, "cvcPlaceholder", defaultLocale.cvcPlaceholder),
      descriptionLabel: Utils.getString(res, "descriptionLabel", defaultLocale.descriptionLabel),
      descriptionPlaceholder: Utils.getString(
        res,
        "descriptionPlaceholder",
        defaultLocale.descriptionPlaceholder,
      ),
      dialingCodePlaceholder: Utils.getString(
        res,
        "dialingCodePlaceholder",
        defaultLocale.dialingCodePlaceholder,
      ),
      documentNumberLabel: Utils.getString(
        res,
        "documentNumberLabel",
        defaultLocale.documentNumberLabel,
      ),
      documentNumberPlaceholder: Utils.getString(
        res,
        "documentNumberPlaceholder",
        defaultLocale.documentNumberPlaceholder,
      ),
      documentTypeLabel: Utils.getString(res, "documentTypeLabel", defaultLocale.documentTypeLabel),
      documentTypePlaceholder: Utils.getString(
        res,
        "documentTypePlaceholder",
        defaultLocale.documentTypePlaceholder,
      ),
      expiryMonthLabel: Utils.getString(res, "expiryMonthLabel", defaultLocale.expiryMonthLabel),
      expiryMonthPlaceholder: Utils.getString(
        res,
        "expiryMonthPlaceholder",
        defaultLocale.expiryMonthPlaceholder,
      ),
      expiryYearLabel: Utils.getString(res, "expiryYearLabel", defaultLocale.expiryYearLabel),
      expiryYearPlaceholder: Utils.getString(
        res,
        "expiryYearPlaceholder",
        defaultLocale.expiryYearPlaceholder,
      ),
      firstNamePlaceholder: Utils.getString(
        res,
        "firstNamePlaceholder",
        defaultLocale.firstNamePlaceholder,
      ),
      giftCardCvcPlaceholder: Utils.getString(
        res,
        "giftCardCvcPlaceholder",
        defaultLocale.giftCardCvcPlaceholder,
      ),
      ...
      ibanPlaceholder: Utils.getString(res, "ibanPlaceholder", defaultLocale.ibanPlaceholder),
      languagePreferenceLabel: Utils.getString(
        res,
        "languagePreferenceLabel",
        defaultLocale.languagePreferenceLabel,
      ),
      languagePreferencePlaceholder: Utils.getString(
        res,
        "languagePreferencePlaceholder",
        defaultLocale.languagePreferencePlaceholder,
      ),
      lastNamePlaceholder: Utils.getString(
        res,
        "lastNamePlaceholder",
        defaultLocale.lastNamePlaceholder,
      ),
      postalCodePlaceholder: Utils.getString(
        res,
        "postalCodePlaceholder",
        defaultLocale.postalCodePlaceholder,
      ),
      productNameLabel: Utils.getString(res, "productNameLabel", defaultLocale.productNameLabel),
      productNamePlaceholder: Utils.getString(
        res,
        "productNamePlaceholder",
        defaultLocale.productNamePlaceholder,
      ),
      routingNumberPlaceholder: Utils.getString(
        res,
        "routingNumberPlaceholder",
        defaultLocale.routingNumberPlaceholder,
      ),
      sortCodePlaceholder: Utils.getString(
        res,
        "sortCodePlaceholder",
        defaultLocale.sortCodePlaceholder,
      ),
      sourceBankAccountIdLabel: Utils.getString(
        res,
        "sourceBankAccountIdLabel",
        defaultLocale.sourceBankAccountIdLabel,
      ),
      sourceBankAccountIdPlaceholder: Utils.getString(
        res,
        "sourceBankAccountIdPlaceholder",
        defaultLocale.sourceBankAccountIdPlaceholder,
      ),
