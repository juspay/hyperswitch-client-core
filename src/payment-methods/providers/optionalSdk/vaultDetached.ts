/* @juspay-tech/react-native-hyperswitch-vault/detached, loaded with import() (see ../sdkChunks.ts). The package is
...
try {
  sdk = require('@juspay-tech/react-native-hyperswitch-vault/detached');
} catch {
  sdk = null;
}
