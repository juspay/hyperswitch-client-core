...
let localeStrings = [
  ...
  //    Hebrew (he),
  {
    ...
    invalidDigitsCardHolderNameError: "שם בעל הכרטיס אינו יכול להכיל מספרים",
    nickNameLengthExceedError: "כינוי לא יכול לעלות על 12 תווים",
    invalidDigitsNickNameError: "כינוי לא יכול להכיל יותר מ-2 מספרים",
  ...
  //    French (fr),
  {
    ...
    invalidDigitsCardHolderNameError: "Le nom du titulaire de la carte ne peut pas contenir de chiffres",
    nickNameLengthExceedError: "Le surnom ne peut pas dépasser 12 caractères",
    invalidDigitsNickNameError: "Le surnom ne peut pas contenir plus de 2 chiffres",
  ...
  //    Japanese (ja),
  {
    ...
    invalidDigitsCardHolderNameError: "カード保持者の名前に数字を含めることはできません",
    nickNameLengthExceedError: "ニックネームは12文字を超えることはできません",
    invalidDigitsNickNameError: "ニックネームに2つ以上の数字を含めることはできません",
  ...
  //    German (de),
  {
    ...
    invalidDigitsCardHolderNameError: "Der Name des Karteninhabers darf keine Ziffern enthalten",
    nickNameLengthExceedError: "Der Spitzname darf 12 Zeichen nicht überschreiten",
    invalidDigitsNickNameError: "Der Spitzname darf nicht mehr als 2 Ziffern enthalten",
  ...
  //    Spanish (es)
  {
    ...
    invalidDigitsCardHolderNameError: "El nombre del titular de la tarjeta no puede tener dígitos",
    nickNameLengthExceedError: "El apodo no puede superar los 12 caracteres",
    invalidDigitsNickNameError: "El apodo no puede tener más de 2 dígitos",
  ...
  //    Catalan (ca)
  {
    ...
    invalidDigitsCardHolderNameError: "El nom del titular de la targeta no pot tenir dígits",
    nickNameLengthExceedError: "El sobrenom no pot superar els 12 caràcters",
    invalidDigitsNickNameError: "El sobrenom no pot tenir més de 2 dígits",
  ...
  //    Portuguese (pt)
  {
    ...
    cardExpiresText: `expira`,
    invalidDigitsCardHolderNameError: "O nome do titular do cartão não pode conter dígitos",
    nickNameLengthExceedError: "O apelido não pode exceder 12 caracteres",
    invalidDigitsNickNameError: "O apelido não pode conter mais de 2 dígitos",
  ...
  //    Italian (it)
  {
    ...
    invalidDigitsCardHolderNameError: "Il nome del titolare della carta non può contenere cifre",
    nickNameLengthExceedError: "Il soprannome non può superare i 12 caratteri",
    invalidDigitsNickNameError: "Il soprannome non può contenere più di 2 cifre",
  ...
  //    Polish (pl)
  {
    ...
    invalidDigitsCardHolderNameError: "Imię posiadacza karty nie może zawierać cyfr",
    nickNameLengthExceedError: "Pseudonim nie może przekraczać 12 znaków",
    invalidDigitsNickNameError: "Pseudonim nie może zawierać więcej niż 2 cyfry",
    cardHolderNameRequiredText: `wymagane imię właściciela karty`,
  ...
  //    Dutch (nl)
  {
    ...
    nickNameLengthExceedError: "De bijnaam mag niet langer zijn dan 12 tekens",
    invalidDigitsNickNameError: "De bijnaam mag niet meer dan 2 cijfers bevatten",
  ...
  //    Swedish (sv)
  {
    ...
    invalidDigitsCardHolderNameError: "Kortinnehavarens namn får inte innehålla siffror",
    nickNameLengthExceedError: "Smeknamnet får inte överstiga 12 tecken",
    invalidDigitsNickNameError: "Smeknamnet får inte innehålla mer än 2 siffror",
  ...
  //    Russian (ru)
  {
    ...
    invalidDigitsCardHolderNameError: "Имя владельца карты не может содержать цифры",
    nickNameLengthExceedError: "Никнейм не может превышать 12 символов",
    invalidDigitsNickNameError: "Никнейм не может содержать более 2 цифр",
  ...
  //    Lithuanian (lt)
  {
    ...
    invalidDigitsCardHolderNameError: "Kortelės turėtojo vardas negali turėti skaitmenų",
    nickNameLengthExceedError: "Slapyvardis negali viršyti 12 simbolių",
    invalidDigitsNickNameError: "Slapyvardis negali turėti daugiau nei 2 skaitmenų",
  ...
  //    Czech (cs)
  {
    ...
    invalidDigitsCardHolderNameError: "Jméno držitele karty nesmí obsahovat číslice",
    nickNameLengthExceedError: "Přezdívka nesmí překročit 12 znaků",
    invalidDigitsNickNameError: "Přezdívka nesmí obsahovat více než 2 číslice",
  ...
  //    Slovak (sk)
  {
    ...
    cardExpiresText: `vyprší`,
    invalidDigitsCardHolderNameError: "Meno držiteľa karty nesmie obsahovať číslice",
    nickNameLengthExceedError: "Prezývka nesmie presiahnuť 12 znakov",
    invalidDigitsNickNameError: "Prezývka nesmie obsahovať viac ako 2 číslice",
  ...
  //    Icelandic (is)
  {
    ...
    invalidDigitsCardHolderNameError: "Nafn korthafa má ekki innihalda tölustafi",
    nickNameLengthExceedError: "Gælunafn má ekki fara yfir 12 stafi",
    invalidDigitsNickNameError: "Gælunafn má ekki innihalda fleiri en 2 tölustafi",
  ...
  //    Welsh (cy)
  {
    ...
    invalidDigitsCardHolderNameError: "Ni all enw deiliad y cerdyn gynnwys rhifau",
    nickNameLengthExceedError: "Ni all llysenw fod yn fwy na 12 nod",
    invalidDigitsNickNameError: "Ni all llysenw gynnwys mwy na 2 rif",
  ...
  //    Greek (el)
  {
    ...
    invalidDigitsCardHolderNameError: "Το όνομα του κατόχου της κάρτας δεν μπορεί να περιέχει ψηφία",
    nickNameLengthExceedError: "Το ψευδώνυμο δεν μπορεί να υπερβαίνει τους 12 χαρακτήρες",
    invalidDigitsNickNameError: "Το ψευδώνυμο δεν μπορεί να περιέχει περισσότερα από 2 ψηφία",
  ...
  //    Estonian (et)
  {
    ...
    invalidDigitsCardHolderNameError: "Kaardi omaniku nimi ei tohi sisaldada numbreid",
    nickNameLengthExceedError: "Hüüdnimi ei tohi ületada 12 tähemärki",
    invalidDigitsNickNameError: "Hüüdnimi ei tohi sisaldada rohkem kui 2 numbrit",
  ...
  //    Finnish (fi)
  {
    ...
    invalidDigitsCardHolderNameError: "Kortinhaltijan nimi ei voi sisältää numeroita",
    nickNameLengthExceedError: "Lempinimi ei saa ylittää 12 merkkiä",
    invalidDigitsNickNameError: "Lempinimessä ei voi olla yli 2 numeroa",
  ...
  //    Norwegian (no)
  {
    ...
    invalidDigitsCardHolderNameError: "Kortinnehaverens navn kan ikke inneholde sifre",
    nickNameLengthExceedError: "Kallenavn kan ikke overstige 12 tegn",
    invalidDigitsNickNameError: "Kallenavn kan ikke ha mer enn 2 sifre",
  ...
  //    Bosnian (bs)
  {
    ...
    invalidDigitsCardHolderNameError: "Ime vlasnika kartice ne može sadržavati brojeve",
    nickNameLengthExceedError: "Nadimak ne može imati više od 12 znakova",
    invalidDigitsNickNameError: "Nadimak ne može sadržavati više od 2 broja",
  ...
  //    Danish (da)
  {
    ...
    invalidDigitsCardHolderNameError: "Kortholderens navn må ikke indeholde tal",
    nickNameLengthExceedError: "Kælenavn må ikke overstige 12 tegn",
    invalidDigitsNickNameError: "Kælenavn må ikke indeholde mere end 2 tal",
  ...
  //    Malay (ms)
  {
    ...
    invalidDigitsCardHolderNameError: "Nama Pemegang Kad tidak boleh mengandungi digit",
    nickNameLengthExceedError: "Nama samaran tidak boleh melebihi 12 aksara",
    invalidDigitsNickNameError: "Nama samaran tidak boleh mempunyai lebih daripada 2 digit",
  ...
  //    Turkish (tr-CY)
  {
    ...
    invalidDigitsCardHolderNameError: "Kart sahibinin adı rakam içermemelidir",
    nickNameLengthExceedError: "Takma ad 12 karakteri aşamaz",
    invalidDigitsNickNameError: "Takma ad 2'den fazla rakam içeremez",
